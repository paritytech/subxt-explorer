...
/**
 * Extremely hacky and unstable solution to show only important code. Should probably be replaced with something more solid later. Slices a code snippet into 3 segments:
 *
 * Boring:
 * ```
 * use std::mem::take;
