...
//   var path_to_root = ""; // todo: currently not used
//   var default_theme = window.matchMedia("(prefers-color-scheme: dark)").matches
//     ? "navy"
//     : "light";
//   console.log("default theme is setup now", default_theme);
//   (function workAroundLocalStorageValues() {
//     try {
...
//   (function setThemeBeforeContentIsLoaded() {
...
// export function afterDOMLoaded() {
...
//   //   Array.from(document.querySelectorAll("code.hljs")).forEach(function (
//   //     block
//   //   ) {
...
//     function get_theme() {
//       console.log("get_theme is called", default_theme);
//       var default_theme;
//       var theme;
//       try {
//         theme = localStorage.getItem("mdbook-theme");
...
// export function afterSidebarLoaded() {
...
// export function afterMenuBarLoaded() {
//   document
